// This component shows more details about the selected list view item

'use strict';

var React = require('react-native');
var { StyleSheet, Image, View, Text, Component } = React;
...
class PropertyDetail extends Component {
	render() {
		...
		if (property.bathroom_number) {
			...
			// if element is more than 1, display "bathrooms" instead of "bathroom"
		} // end if
